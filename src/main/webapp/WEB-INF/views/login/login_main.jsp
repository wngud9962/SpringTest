...
<script type="text/javascript">
	function send(f) {
		...
		var url = "login.do";
		var param = "u_email=" + encodeURIComponent(u_email) + "&u_pwd="
				+ encodeURIComponent(u_pwd);
	...
	<div class="wrapper">
		<div class="header_wrapper">
			<div class="logo_wrapper">
				<a href="main_home.do" class="logo"> MY PET DOC </a>
			</div>
		</div>
		<div class="login_wrapper">
			...
			<form id="login-form">
				...
				<div class="regNfind">
					<a href="find_id.do" class="findId">아이디 찾기</a> <a
						href="find_pwd.do" class="findPwd">비밀번호 찾기</a> <a
						href="regster_insert.do" class="reg_a">회원가입</a>
				</div>
				<input type="button" class="checkbtn" value="Login"
