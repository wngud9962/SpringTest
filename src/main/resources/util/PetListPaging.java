...
public class PetListPaging {

	// page_product_quantity = 페이지당 보여줄 상품리스트 개수
	// nowpage = 요청된 페이지 인덱스 정보
	// Object dao = 데이터 조회에 사용되는 연결객체
	public static HashMap<String, Object> getPaging(int page_product_quantity, String nowpage, PetDAO dao, UserVO userData) {
		...
		goodsList = dao.loginUserPetList(pagingSource);
		// 총 데이터 수량을 저장
		goodsCount = dao.userPetListCount(userData);
